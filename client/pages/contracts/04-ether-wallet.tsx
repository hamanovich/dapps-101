...
import ABI from "../../public/contracts/EtherWallet.sol/EtherWallet.json";

const EtherWallet: NextPage = () => {
  ...
  useEffect(() => {
    const getBalance = async () => {
      const contract = new ethers.Contract(
        process.env.NEXT_PUBLIC_04_CONTRACT as string,
        ABI.abi,
  ...
  return (
    <>
      <h1 className="text-3xl font-bold mb-4">Ether Wallet</h1>
      ...
      <p className="mb-3 text-lg font-light text-gray-500 md:text-xl dark:text-gray-400">
        Contract address: {process.env.NEXT_PUBLIC_04_CONTRACT}
      </p>
